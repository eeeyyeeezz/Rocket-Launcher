...
extension InfoScreenView {
    func addConstraints() {
        ...
        NSLayoutConstraint.activate([
            parametrsCollectionView.topAnchor.constraint(equalTo: rocketName.bottomAnchor, constant: 30),
            parametrsCollectionView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 20),
            parametrsCollectionView.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -20),
            parametrsCollectionView.widthAnchor.constraint(equalToConstant: 100),
